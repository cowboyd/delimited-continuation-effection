...
//   it("can continue after invoking a continuation from another context", () => {
//     let reached = false;
//     evaluate(function*() {
//       let k = yield* reset<Continuation<string, string>>(function* computation() {
//         let container = yield* shift(function* (k) {
//           return k;
//         });
//         return `message in a ${container}`;
//       });

//       let result = yield* k("bottle");

//       reached = true;

//       expect(result).toEqual("message in a bottle")
//     });

//     expect(reached).toEqual(true);
//   });

//   it("can invoke a continuation immediately", () => {
//     expect(evaluate(function* () {
//       let result = yield* reset(function* () {
...
//   it.skip("can recurse to arbirtary depths without overflowing the call stack", () => {
